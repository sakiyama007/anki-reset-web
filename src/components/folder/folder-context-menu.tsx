...
import { List, Plus, FolderPlus, FolderInput, Pencil, SlidersHorizontal, Trash2 } from 'lucide-react';
...
export function FolderContextMenu({
  ...
  const items = [
    ...
    { label: '移動', icon: FolderInput, action: () => onMove(info) },
